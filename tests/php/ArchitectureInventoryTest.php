...
final class ArchitectureInventoryTest extends TestCase {
	...
	public function test_dependency_graph_records_required_reference_categories(): void {
		...
		$this->assertSame( 76, $graph['summary']['files'] );
		$this->assertSame( 72, $graph['summary']['class_like_nodes'] );
		$this->assertSame( 4, $graph['summary']['procedural_nodes'] );
		$this->assertSame( 344, $graph['summary']['edges'] );
		$this->assertSame( 343, $graph['summary']['runtime_edges'] );
	...
	public function test_heat_map_and_cycle_evidence_is_structurally_valid(): void {
		...
		$this->assertCount( 59, $graph['metrics']['cycles_by_classification']['runtime'][0]['members'] );
		$this->assertCount( 302, $graph['metrics']['cycles_by_classification']['runtime'][0]['edges'] );
