...
class LiteSpeedEsiTest extends \PHPUnit\Framework\TestCase {
	...
	public function test_enqueue_hydration_client_fires_on_ols_placeholder_mode(): void {
		...
		$this->assertTrue( $this->esi_hook_state['enqueued'][0]['args'], 'Client must load in the footer (bool $in_footer keeps WP 6.2 compat; the array $args form needs WP 6.3+)' );
