		...
		public static function get_default_settings(): array {
			return array(
				...
				'file_optimisation'     => array(
					...
					// Legacy #925 key kept in the canonical schema so stored
					// pre-removal values are recognised by verify; false never
					// enables any behavior (the read-site only schedules a
					// one-time notice and always preserves ?ver=).
				...
				'image_optimisation'    => array(
					...
					// Mirrors Image_Optimisation::MAX_PRELOAD_WIDTH (private const),
					// the read-site fallback when the key is absent.
					'maxWidthImgSize'            => 1478,
					'excludeSize'                => '',
