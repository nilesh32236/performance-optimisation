...
if ( ! class_exists( 'PerformanceOptimise\Inc\Util' ) ) {
	...
	class Util {
		 ...
		 *
		 * Backward-compatible facade for the canonical
		 * {@see Settings_Store::get_default_settings()} defaults used by Main,
		 * activation, CLI, and schema verification. Covers all allowed tabs;
		 * object_cache stays empty (no defaults) for BC, and database_cleanup
		 * carries only the additive autoloadThreshold default (issue #934).
		 *
		 ...
		 *
		 * @since 2.0.0
		 * @since NEXT Delegates canonical defaults to Settings_Store.
