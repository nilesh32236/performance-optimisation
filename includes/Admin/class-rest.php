...
if ( ! class_exists( 'PerformanceOptimise\Inc\Rest' ) ) {
	...
	class Rest {
		 ...
		 *
		 * Compatibility facade for the shared administrative authentication
		 * policy. The optional request signature remains unchanged for REST
		 * callbacks and direct legacy callers.
		 *
		 * @since 1.0.0
		...
		public function permission_callback( ?\WP_REST_Request $request = null ): bool {
			return Admin_Auth::permission_check( $request );
		}
