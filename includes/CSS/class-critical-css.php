...
if ( ! class_exists( 'PerformanceOptimise\Inc\Critical_CSS' ) ) {
	...
	class Critical_CSS {
		 ...
		 *
		 * BC alias (P3-018): the canonical value lives on
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::LAST_FULL_REGEN_OPTION};
		 * the policy reads the owner constant directly. Pinned equal by
		 * CcssBudgetPolicyParityTest so the alias can never drift.
		 *
		 * @since 2.3.0
		 * @var string
		 */
		 ...
		 *
		 * BC alias (P3-018): the canonical value lives on
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::TARGETED_REGEN_OPTION};
		 * the policy reads the owner constant directly. Pinned equal by
		 * CcssBudgetPolicyParityTest so the alias can never drift.
		 *
		 * @since 2.3.0
		...
		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::get_ccss_max_size}.
		 *
		 * @since NEXT
		 * @return int Cap in bytes.
		 */
		public static function get_ccss_max_size(): int {
			return Ccss_Budget_Policy::get_ccss_max_size();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::truncate_to_cap}.
		 *
		 * @since NEXT
		...
		public static function truncate_to_cap( string $css, int $cap ): string {
			return Ccss_Budget_Policy::truncate_to_cap( $css, $cap );
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::get_full_regen_cooldown}.
		 *
		 * @since NEXT
		 * @return int Cooldown in seconds.
		 */
		public static function get_full_regen_cooldown(): int {
			return Ccss_Budget_Policy::get_full_regen_cooldown();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::get_ccss_inline_budget_bytes}.
		 *
		 * @since NEXT
		...
		public static function get_ccss_inline_budget_bytes(): int {
			return Ccss_Budget_Policy::get_ccss_inline_budget_bytes();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::is_full_regen_cooled_down}.
		 *
		 * @since NEXT
		...
		public static function is_full_regen_cooled_down(): bool {
			return Ccss_Budget_Policy::is_full_regen_cooled_down();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::mark_full_regen}.
		 *
		 * @since NEXT
		 * @return void
		 */
		public static function mark_full_regen(): void {
			Ccss_Budget_Policy::mark_full_regen();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::get_targeted_regen_cooldown}.
		 *
		 * @since NEXT
		 * @return int Cooldown in seconds (>= 0).
		 */
		public static function get_targeted_regen_cooldown(): int {
			return Ccss_Budget_Policy::get_targeted_regen_cooldown();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::is_targeted_regen_cooled_down}.
		 *
		 * @since NEXT
		...
		public static function is_targeted_regen_cooled_down(): bool {
			return Ccss_Budget_Policy::is_targeted_regen_cooled_down();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::mark_targeted_regen}.
		 *
		 * @since NEXT
		 * @return void
		 */
		...
		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::estimate_committed_inline_bytes}.
		 *
		 * @since NEXT
		 * @return int Committed inline bytes (>= 0).
		 */
		public static function estimate_committed_inline_bytes(): int {
			return Ccss_Budget_Policy::estimate_committed_inline_bytes();
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::get_effective_ccss_budget}.
		 *
		 * @since NEXT
		...
		public static function get_effective_ccss_budget( int $already_inlined = 0 ): int {
			return Ccss_Budget_Policy::get_effective_ccss_budget( $already_inlined );
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::coordinate_inline_budgets}.
		 *
		 * @since NEXT
		...
		public static function coordinate_inline_budgets( string $ccss, string|int $used_css = '' ): array {
			return Ccss_Budget_Policy::coordinate_inline_budgets( $ccss, $used_css );
		}
		...
		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::gzipped_size}.
		 *
		 * @since NEXT
		 * @param string $css CSS content.
		...
		public static function gzipped_size( string $css ): int {
			return Ccss_Budget_Policy::gzipped_size( $css );
		}

		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::is_over_inline_budget}.
		 *
		 * @since NEXT
		 * @param string $css CSS content.
		...
		public static function is_over_inline_budget( string $css ): bool {
			return Ccss_Budget_Policy::is_over_inline_budget( $css );
		}
		...
		/**
		 * Facade proxy (P3-018): canonical owner is
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::get_ccss_inline_budget_label}.
		 *
		 * @since NEXT
		 * @return string e.g. "14 KB" or "2.5 KB".
		 */
		public static function get_ccss_inline_budget_label(): string {
			return Ccss_Budget_Policy::get_ccss_inline_budget_label();
		}
		...
		/**
		 * Reset the per-request CCSS memos (facade, FUT-001 / P3-018).
		 *
		 * Generation-domain half lives here; storage-domain half lives on
		 * {@see \PerformanceOptimise\Inc\Ccss_Store::reset_ccss_memo()} and
		 * the budget-policy half on
		 * {@see \PerformanceOptimise\Inc\Ccss_Budget_Policy::reset_ccss_memo()}.
		 * All halves are cleared so existing callers stay identical.
		 *
		 * @since 2.4.0
		 * @return void
		 */
		public static function reset_ccss_memo(): void {
			...
			Ccss_Budget_Policy::reset_ccss_memo();
		}
