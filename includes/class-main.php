		...
		wp_localize_script(
			...
			array(
				...
				'translations' => array(
					...
					'imgOptimiseSuccess'    => __( 'Images optimized successfully', '' ),
					'errorOptimiseImg'      => __( 'Error optimizing images:', '' ),
					'noImgRemove' => __( 'No optimized images to remove!', '' ),
					'removedOptimiseImg' => __( 'Optimized images removed successfully!', '' ),
					'removedImg' => __( 'Removed images: ', '' ),
					'someImgNotRemoved' => __( 'Some images could not be removed.', '' ),
					'failedToRemove' => __( 'Failed to remove:', '' ),
					'errorRemovingImg' => __( 'Error removing optimized images:', '' ),
					'errorEccurredRemovingImg' => __( 'An error occurred while removing optimized images.', '' ),
					'cacheStatus' => __( 'Cache Status', '' ),
					'currentCacheSize' => __( 'Current Cache Size: ', '' ),
					'clearing' => __( 'Clearing...', '' ),
					'clearCacheNow' => __( 'Clear Cache Now', '' ),
					'JSCSSOptimisation' => __( 'JavaScript & CSS Optimization', '' ),
					'JSFilesMinified' => __( 'JavaScript Files Minified: ', '' ),
					'CSSFilesMinified' => __( 'CSS Files Minified: ', '' ),
