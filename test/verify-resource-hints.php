...
namespace {
    ...
    $settings->set_mock_setting('preloading', 'dns_prefetch', ['example.com']);
    ob_start();
    ...
    // Test 2: Preconnect
    echo "\nTest 2: Preconnect\n";
    $settings->set_mock_setting('preloading', 'preconnect', ['https://cdn.example.com']);
    ob_start();
    ...
    echo "\nTest 3: Preload Images\n";
    $settings->set_mock_setting('preloading', 'preload_images', ['https://example.com/image.jpg']);
    ob_start();
