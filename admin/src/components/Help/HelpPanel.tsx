				...
				<div className="wppo-help-panel__content">
					{sections.map((section) => (
						<div key={section.id} className="wppo-help-section">
							...
							>
								<h4 className="wppo-help-section__title">
									{section.title}
								</h4>
								<span className="wppo-help-section__toggle">
									<span className={`dashicons ${activeSection === section.id ? 'dashicons-minus' : 'dashicons-plus-alt'}`}></span>
								</span>
							</div>
					...
					<div className="wppo-help-panel__footer">
						<div className="wppo-help-panel__actions">
							<Button
								variant="secondary"
								size="small"
								onClick={() => window.open('/wp-admin/admin.php?page=performance-optimisation-docs', '_blank')}
							>
							...
							<Button
								variant="tertiary"
								size="small"
								onClick={() => window.open('https://wordpress.org/support/plugin/performance-optimisation/', '_blank')}
							>
								Get Support
							</Button>
						</div>
