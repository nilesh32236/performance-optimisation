			...
			<div className="wppo-metrics-overview__grid">
				<Card className="wppo-metric-card">
					<div className="wppo-metric-card__content">
						...
						<div className="wppo-metric-card__details">
							<div className={`wppo-metric-card__value wppo-metric-card__value--${getScoreColor(overview.performance_score)}`}>
				...
				<Card className="wppo-metric-card">
					<div className="wppo-metric-card__content">
						...
						<div className="wppo-metric-card__details">
							<div className={`wppo-metric-card__value wppo-metric-card__value--${getLoadTimeColor(overview.average_load_time)}`}>
				...
				<Card className="wppo-metric-card">
					<div className="wppo-metric-card__content">
						...
						<div className="wppo-metric-card__details">
							<div className={`wppo-metric-card__value wppo-metric-card__value--${getCacheColor(overview.cache_hit_ratio)}`}>
