...
const InteractiveChart: React.FC<InteractiveChartProps> = ( {
	...
	const getMetricColors = ( metricName: string ) => {
		...
		return (
			colorSchemes[ metricName as keyof typeof colorSchemes ] || colorSchemes.optimization_score
		);
	};
				...
				<div className="wppo-chart-tooltip">
					...
					<div className="wppo-chart-tooltip__content">
						<div className="wppo-chart-tooltip__item">
							...
							<span className="wppo-chart-tooltip__value">{ data.formattedValue }</span>
						</div>
						{ data.sample_count && (
							<div className="wppo-chart-tooltip__item">
