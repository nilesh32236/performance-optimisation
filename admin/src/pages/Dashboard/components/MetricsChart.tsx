    ...
    <div className="wppo-metrics-chart">
      ...
      <div className="wppo-metrics-chart__legend">
        <div className="wppo-metrics-chart__legend-item">
          <span className="wppo-metrics-chart__legend-color" style={{ backgroundColor: '#007cba' }}></span>
          Current Performance
        </div>
        <div className="wppo-metrics-chart__legend-item">
          <span className="wppo-metrics-chart__legend-color wppo-metrics-chart__legend-color--dashed" style={{ backgroundColor: '#d63638' }}></span>
          Industry Benchmark
        </div>
      </div>
    </div>
