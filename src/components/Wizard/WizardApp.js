...
function WizardApp({ wizardData }) {
    ...
    const handleFinish = useCallback(async () => {
        ...
        try {
            ...
            if (!apiUrl || !nonce) {
                throw new Error('Missing required configuration. Please refresh the page and try again.');
            }
    ...
    return (
        <div className="wppo-wizard-container" role="main" aria-label="Setup Wizard">
            ...
            <div className="wppo-wizard-header">
                <h1 id="wppo-wizard-title">{translations?.welcomeTitle || 'Performance Optimisation Setup'}</h1>
                <StepIndicator 
