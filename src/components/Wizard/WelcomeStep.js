...
function WelcomeStep({ translations, onNext }) {
    return (
        <div className="wppo-wizard-step wppo-welcome-step" role="region" aria-labelledby="welcome-title">
            <div className="wppo-welcome-content">
                ...
                <h2 id="welcome-title">{translations?.welcomeTitle || 'Welcome to Performance Optimisation!'}</h2>
                
                <p className="wppo-welcome-description">
                    {translations?.welcomeDescription || 'Let\'s make your site fast in just a few clicks.'}
                </p>
                ...
                <p className="wppo-welcome-note">
                    This wizard will guide you through selecting the best performance settings for your website. 
                    The entire process takes less than 2 minutes and can be changed later if needed.
                </p>
            </div>
