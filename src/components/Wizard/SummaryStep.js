...
function SummaryStep({ translations, selections, isLoading, onFinish, onBack }) {
    ...
    const getPresetFeatures = (presetId) => {
        ...
        switch (presetId) {
            ...
            case 'aggressive':
                return [...baseFeatures, 'CSS & HTML Minification', 'Combine CSS Files', 'JavaScript Minification', 'Defer JavaScript', 'Delay JavaScript'];
            default:
                return baseFeatures;
        }
    };
    ...
    return (
        <div className="wppo-wizard-step wppo-summary-step">
            <div className="wppo-step-header">
                <h2>Setup Summary</h2>
                <p>Review your selections below. Once you click "Finish Setup", these optimizations will be applied to your website.</p>
            </div>
                ...
                <div className="wppo-nav-buttons">
                    ...
                    >
                        {isLoading ? (
                            ...
                            <>
                                {translations?.finishSetup || 'Finish Setup & Start Optimizing'}
                                <span className="dashicons dashicons-yes-alt"></span>
                            </>
                        )}
                    </button>
