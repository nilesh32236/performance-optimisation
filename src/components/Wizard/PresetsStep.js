...
function PresetsStep({ translations, selectedPreset, onPresetChange, onNext, onBack }) {
    const presets = [
        ...
        },
        {
            ...
            description: 'The best balance of speed and compatibility for most websites. Includes asset optimization.',
            features: [
                'Page Caching',
                'Image Lazy Loading',
        ...
        },
        {
            ...
            description: 'For maximum performance. May require testing, as some scripts can be sensitive.',
            features: [
    ...
    return (
        <div className="wppo-wizard-step wppo-presets-step" role="region" aria-labelledby="presets-title">
            <div className="wppo-step-header">
                <h2 id="presets-title">Choose Your Optimization Level</h2>
                <p className="wppo-step-description">
                    Select the optimization preset that best fits your website's needs. You can always change this later.
                </p>
            </div>
            
            <fieldset className="wppo-presets-grid" role="radiogroup" aria-labelledby="presets-title">
