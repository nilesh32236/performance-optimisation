					...
					<div className="wppo-field-group">
						...
						{ settings.enablePreloadCache && (
							<div className="wppo-mt-20">
								...
								/>
								<p id="excludePreloadCache-desc" className="wppo-text-muted wppo-mt-10 wppo-text-small">
					...
					<div className="wppo-field-group">
						...
						{ settings.preconnect && (
							<div className="wppo-field">
								...
								/>
								<p id="preconnectOrigins-desc" className="wppo-text-muted wppo-mt-10 wppo-text-small">
						...
						{ settings.prefetchDNS && (
							<div className="wppo-field">
								...
								/>
								<p id="dnsPrefetchOrigins-desc" className="wppo-text-muted wppo-mt-10 wppo-text-small">
						...
						<div className="wppo-field-group">
							...
							{ settings.preloadFonts && (
								<div className="wppo-field">
									...
									/>
									<p id="preloadFontsUrls-desc" className="wppo-text-muted wppo-mt-10 wppo-text-small">
						...
						<div className="wppo-field-group">
							...
							{ settings.preloadCSS && (
								<div className="wppo-field">
									...
									/>
									<p id="preloadCSSUrls-desc" className="wppo-text-muted wppo-mt-10 wppo-text-small">
