								...
								{ serverRules?.server_type === 'nginx' && (
									<div className="wppo-nginx-rules wppo-mt-20">
										<div className="wppo-notice wppo-notice--info wppo-mb-16">
											...
											/>
											<span>
												<strong>Nginx Detected:</strong> Server rules cannot be applied automatically on Nginx. Please copy the rules below into your server configuration.
											</span>
										</div>
