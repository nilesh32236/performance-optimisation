...
## 2024-05-16 - [JS Test Fix] fetchRecentActivities assertions
...
## 2024-05-17 - [JS Test Fix] Testing UI component in jsdom
...
## 2026-05-17 - [JS Test Fix] Testing Complex Forms in jsdom
**Bug/Gap:** The DatabaseCleanup.js component, which handles critical data deletion and saving form settings to the database via API, was entirely untested, leaving form state mutations, validation, and network error handling unverified.
**Root Cause:** The project lacks comprehensive coverage over all Dashboard components. Tests require specific boilerplate including WordPress component global mocking like window.matchMedia.
**Test Added:** Added a unit test suite src/components/__tests__/DatabaseCleanup.test.js covering state interactions (changing dbSchedule), validating that the correct API payloads are sent, and verifying sad path cleanup failures show the correct notifications.
