...
## 2024-05-18 - Dynamic Color Gradients and Shadows
**Learning:** Hardcoded hex/rgba colors like #818cf8 and rgba(99, 102, 241, X) break WordPress theme adaptation.
**Action:** Always use color-mix() with var(--wp-admin-theme-color) or a local variable mapped to it (like var(--wppo-primary)) to safely adapt to dynamic WP themes without clashing.
