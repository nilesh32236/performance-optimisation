...
## 2026-07-10 - Always replace hardcoded white backgrounds
**Learning:** Hardcoded `#fff` backgrounds in cards, dialogs, and forms break the native WP admin dark mode integration.
**Action:** Use `var(--wppo-bg-card)` or `var(--wppo-bg-card-surface)` instead to ensure native WP admin theme adaptation.
