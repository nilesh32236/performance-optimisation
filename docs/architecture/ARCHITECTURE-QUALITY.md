...
P3-002 records these baselines:
...
| Compatibility-classified edges | 193 | Explain and reduce only through explicit compatibility ownership |
...
| Bridge candidates | 228 | Reduce after caller migration |
