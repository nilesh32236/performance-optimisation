...
P3-001 records these baselines:
...
| Compatibility-classified edges | 191 | Explain and reduce only through explicit compatibility ownership |
...
| Bridge candidates | 226 | Reduce after caller migration |
