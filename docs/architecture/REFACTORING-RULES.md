...
|---|---:|---|
| `Main` lines / methods | 11,091 / 235 | Do not grow without a documented extraction path |
| `Main` methods at least 80 lines | 21 | Target down |
...
| Compatibility-classified edges | 191 | Explain and reduce through explicit compatibility ownership |
...
| Bridge candidates | 226 | Target down |
