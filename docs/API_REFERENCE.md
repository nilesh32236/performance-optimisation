...
This document provides comprehensive API documentation for the Performance Optimisation plugin, including PHP APIs (utility classes, services, optimizers) and REST API endpoints.
